                        ...
                        <li class="active">
                            ...
                            <ul class="nav nav-second-level">
                                ...
                                <li>
                                 ...
                                 <li>
                                    <a class="active" href="<?php echo site_url(). 'Settings';?>">System settings</a>
                                </li>
                            </ul>
                            </ul>
                            <!-- /.nav-second-level -->
             ...
             <?php echo form_open('customers/new_customer');  ?>
                   ...
                   <div class="row">
                        ...
                        <div class="col-md-4">
                                ...
                                <input type="text" class="form-control" placeholder="" name="discount" value="">  
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            ...
                            <div class="form-group">
                                ...
                                <input type="password" class="form-control" placeholder="" name="discount" value="">  
                            </div>    
                            </div>
                    ...
                    <?php $button = array('class' => 'btn btn-default', 'type' => 'submit', 'name' => 'submit', 'content' => 'Update settings'); ?>
